...
import HeaderNavDropdown from '../components/navigation/HeaderNavDropdown';
...
export default function TestimonialsPage({ standalone = true }: TestimonialsPageProps) {
  ...
  return (
    <div className="min-h-screen flex flex-col">
        ...
        <header className="sticky top-0 z-50 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/80 border-b border-border">
          <div className="container mx-auto px-3 sm:px-4 py-3 sm:py-4">
            <div className="flex items-center justify-between gap-2 sm:gap-4">
              ...
              <HeaderNavDropdown onNavigate={handleNavigation} currentRoute="testimonials" />
            </div>
          </div>
        </header>
      )}
      ...
      {/* Footer - only show in standalone mode */}
      {standalone && <AppFooter />}
    </div>
  );
}
