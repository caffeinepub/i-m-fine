      ...
      <div className="max-w-3xl mx-auto">
        ...
        <Accordion type="single" collapsible className="space-y-4">
          ...
          <AccordionItem value="item-8" className="bg-card border border-border rounded-lg px-6">
            <AccordionTrigger className="text-left hover:no-underline">
              How does the in-app AI assistant work?
            </AccordionTrigger>
            <AccordionContent className="text-muted-foreground">
              Our AI friend is a supportive companion that helps you navigate the app and find resources. It uses in-app content only (no external AI services) to provide guidance, suggest tools, and direct you to helpful materials. The assistant is educational and supportive only—it does not diagnose, prescribe treatment, or replace professional care. You control when to interact with it, and there's no background listening.
            </AccordionContent>
          </AccordionItem>
        </Accordion>
      </div>
